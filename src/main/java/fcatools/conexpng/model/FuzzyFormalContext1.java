 ...
 */
public class FuzzyFormalContext1 extends de.tudresden.inf.tcs.fcalib.FormalContext<String, FuzzyObject<String,Double>> {
    ...
    public FuzzyFormalContext1() {
        this(0.5);
      }

    public FuzzyFormalContext1(double threshold) {
        super();
        objectsOfAttribute = new HashMap<>(); 
        this.threshold = threshold;
    }
    
    public FuzzyFormalContext1(int objectsCount, int attributesCount) {
      this(objectsCount,attributesCount,0.5);
    	
    }
    public FuzzyFormalContext1(int objectsCount, int attributesCount, double threshold) {
        super();
        objectsOfAttribute = new HashMap<>();
        this.threshold = threshold;
    ...
    public Set<Concept<String, FullObject<String, FuzzyObject<String,Double>>>> getConcepts() {
        ...
        for (Set<FuzzyObject<String,Double>> e : extents) {
            ...
            int count = 0;
            Concept<String, FullObject<String, FuzzyObject<String,Double>>> c = new FuzzyLatticeConcept1();
            if (e.isEmpty()) {
