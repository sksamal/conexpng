 ...
 */
public class TAssociationWorker extends AbstractAssociationWorker {

    // frequent and closed itemsets
    private IndexedSet<Set<SortedSet<String>>> FC;
    private Conf state;
   
    public TAssociationWorker(FormalContext context, Long progressBarId) {
        super(context, progressBarId);
    }

    public TAssociationWorker(Conf state, double minsup, double conf, Long progressBarId) {
    ...
    protected Void doInBackground() throws Exception {
        ...
        setProgressBarMessage(StatusMessage.CALCULATINGASSOCIATIONS.toString());
        init();
